...
var svg1 = d3.select("#svgcontainer5")
.append("g")
.attr("transform",
      "translate(" + margin.left + "," + margin.top + ")")

// get the data
d3.csv("NCAATourneyDetailed.csv").then(function(data) {
                                       ...
                                       var div = d3.select("#svgcontainer5").append("div")
                                       .attr("class", "tooltip")
                                       .style("opacity", 0);
                                         ...
                                         var svg1 = d3.select("#svgcontainer5").append("svg")
                                       ...
                                       d3.select("#buttonXlim1").on("input", updatePlot1 )
